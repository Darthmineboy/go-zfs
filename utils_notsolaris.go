...
var (
	...
	dsPropList = []string{"name", "origin", "used", "available", "mountpoint", "compression", "type", "volsize", "quota", "refquota", "referenced", "written", "logicalused", "logicalreferenced", "usedbydataset", "creation"}
